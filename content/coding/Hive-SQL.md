...
date: 2023-12-22
---
> 本文档基于[黑马程序员-大数据课程](https://www.bilibili.com/video/BV1WY4y197g7/?spm_id_from=333.1007.top_right_bar_window_custom_collection.content.click) + [Hive官方文档](https://cwiki.apache.org/confluence/display/Hive/LanguageManual) 整理。
...
注意：不会在HDFS对数据库所在目录进行改名，只是修改location后，新创建的表在新的路径，旧的不变
...
正则规则表：https://tool.oschina.net/uploads/apidocs/jquery/regexp.html
