import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as c,c as o,a as s,d as n,b as i,e as a}from"./app-2l_F50jD.js";const r="/assets/deltas-se4uebBt.png",p="/assets/snapshots-IofYHySJ.png",d="/assets/areas-BufT15rR.png",m="/assets/commit-and-tree-6x02F95k.png",u="/assets/commits-and-parents-AB1H1OsF.png",v="/assets/branch-and-history-5O61GQ6c.png",b="/assets/basic-branching-4-JDqWe1CI.png",g="/assets/basic-branching-5-0n-__sqc.png",h="/assets/basic-merging-1-DBPJNJTw.png",k="/assets/basic-merging-2-rt1nwW72.png",f="/assets/basic-rebase-3-yu7bV2RI.png",x="/assets/remote-branches-5-oNkPrP96.png",_="/assets/reset-ex3-PCH1RCbv.png",A="/assets/reset-ex4-cyKlqbfi.png",E="/assets/reset-ex5-irSlVtuz.png",G="/assets/reset-ex6-gObfIBu_.png",H="/assets/reset-soft-OEe52TVF.png",D="/assets/reset-mixed-LDzXAs9a.png",w="/assets/reset-hard-_KNlxPGY.png",y="/assets/reset-checkout-085pWIJa.png",C="/assets/data-model-1-klC1bNo9.png",q={},z=a('<p>闲来无事，读一读 Git Pro —— Git 圣经，记录一些以前没有注意过的问题和底层实现的原理。</p><h2 id="起步" tabindex="-1"><a class="header-anchor" href="#起步" aria-hidden="true">#</a> 起步</h2><h3 id="特点" tabindex="-1"><a class="header-anchor" href="#特点" aria-hidden="true">#</a> 特点</h3><p>Git 和其它版本控制系统在对待数据的方式上有很大的区别，大部分 VCS 系统（如 CVS、Subversion、Perforce等）以文件变更列表的方式存储系统，也就是基于文件的差异进行版本控制。</p><p><img src="'+r+'" alt="deltas" loading="lazy"></p><p>但是 Git 把数据看作是对小型文件系统的一系列快照，每次提交就会对当前的全部文件创建一个快照并保存这个快照的索引，如果文件没有修改就创建一个指向先前存储的链接。</p><p><img src="'+p+'" alt="" loading="lazy"></p><p>Git 中所有的数据在存储前都计算 SHA-1 校验和，然后以校验和来引用保存的信息。Git 数据库中保存的信息都是以文件内容的哈希值作为索引，而不是文件名。</p><h3 id="三种状态" tabindex="-1"><a class="header-anchor" href="#三种状态" aria-hidden="true">#</a> 三种状态</h3><p>Git 管理的文件，即已跟踪的文件有三种状态，要牢记：</p><ul><li><strong>commited 已提交</strong>：数据已经安全地保存在本地数据库中</li><li><strong>modified 已修改</strong>：修改了文件，但还没保存到数据库中</li><li><strong>staged 已暂存</strong>：对一个已修改文件的当前版本做了标记，使之包含在下次提交的快照中</li></ul><p>这会让我们的 Git 项目拥有三个阶段：</p><ul><li><strong>工作区</strong>：对项目的某个版本，从 Git 压缩数据库中独立提取出来的内容，可以使用和修改，对应<code>已修改</code>状态</li><li><strong>暂存区</strong>：是一个文件，保存了下次将要提交的文件列表信息，对应<code>已暂存</code>状态</li><li><strong>Git 目录</strong>：保存项目的元数据和对象数据库的地方，对应<code>已提交</code>状态</li></ul><p><img src="'+d+`" alt="" loading="lazy"></p><p>基于上面的三种状态和三个阶段，Git 的基本工作流程是这样的：</p><ol><li>在工作区修改文件</li><li>将下次想要提交的修改选择性添加到暂存区</li><li>提交更新，即找到暂存区的文件，将快照永久性存储到 Git 目录</li></ol><h3 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h3><p>Git 的配置分为三级，每一级会覆盖上一级的配置：</p><ol><li>系统级：<code>/etc/gitconfig</code>，针对系统中每一个用户以及他们仓库的通用配置，通过<code>--system</code>选项读写（Windows 在对应安装目录下）</li><li>用户级：<code>~/.gitconfig 或 ~/.config/git/config</code>，针对当前用户，通过<code>--global</code>选项读写（Windows 在C盘Users目录下）</li><li>仓库级：<code>.git/config</code>，针对特定仓库，通过<code>--local</code>选项读写</li></ol><p>可以使用<code>git config --list --show-origin --show-scope</code>命令查看当前环境所有的配置、所在文件位置，以及对应的作用域。<code>git config --show-origin user.email</code>查看最终生效的某个配置和来源。</p><h2 id="基础" tabindex="-1"><a class="header-anchor" href="#基础" aria-hidden="true">#</a> 基础</h2><h3 id="本地命令" tabindex="-1"><a class="header-anchor" href="#本地命令" aria-hidden="true">#</a> 本地命令</h3><h4 id="clone" tabindex="-1"><a class="header-anchor" href="#clone" aria-hidden="true">#</a> clone</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># HTTP/HTTPS 协议，可以指定文件夹名</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="add" tabindex="-1"><a class="header-anchor" href="#add" aria-hidden="true">#</a> add</h4><p>add 命令有多个功能，比如跟踪新文件、放入暂存区、合并冲突时标记已解决等，通常可以把它理解为：精确地将内容添加到下一次提交中。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> <span class="token function">add</span> <span class="token function">file</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="status" tabindex="-1"><a class="header-anchor" href="#status" aria-hidden="true">#</a> status</h4><p><code>-s</code>参数可以简览状态，输出在文件名前有两列，第一列是暂存区状态，第二列是工作区状态，&quot;??&quot;表示尚未跟踪。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> status <span class="token parameter variable">-s</span>
// 输出：
 M README
MM Rakefile
A  lib/git.rb
?? LICENSE.txt
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="diff" tabindex="-1"><a class="header-anchor" href="#diff" aria-hidden="true">#</a> diff</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 比较当前工作区和暂存区文件差异</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="commit" tabindex="-1"><a class="header-anchor" href="#commit" aria-hidden="true">#</a> commit</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 提交所有已跟踪文件的修改，包括工作区和暂存区</span>
<span class="token function">git</span> commit <span class="token parameter variable">-a</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="rm" tabindex="-1"><a class="header-anchor" href="#rm" aria-hidden="true">#</a> rm</h4><p>rm 命令操作的是暂存区和工作目录，不会影响已提交的 Git 数据库</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 取消跟踪某个文件，即删除暂存区和工作目录下的该文件（需要当前暂存区和工作目录一致）</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="restore" tabindex="-1"><a class="header-anchor" href="#restore" aria-hidden="true">#</a> restore</h4><p>注意 rm 和 restore 语义上的区别，虽然在某些场景下效果可能一样</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 取消已暂存但尚未提交的文件修改，还原到最近依次提交时的状态</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="mv" tabindex="-1"><a class="header-anchor" href="#mv" aria-hidden="true">#</a> mv</h4><p>Git 并不显式跟踪文件移动，但可以通过 mv 命令推断更名操作。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> <span class="token function">mv</span> a.txt b.txt
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="log" tabindex="-1"><a class="header-anchor" href="#log" aria-hidden="true">#</a> log</h4>`,44),B={href:"https://git-scm.com/book/zh/v2/Git-%E5%9F%BA%E7%A1%80-%E6%9F%A5%E7%9C%8B%E6%8F%90%E4%BA%A4%E5%8E%86%E5%8F%B2#pretty_format",target:"_blank",rel:"noopener noreferrer"},R=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 打印提交日志和差异信息，并限制条目数为 2</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="amend" tabindex="-1"><a class="header-anchor" href="#amend" aria-hidden="true">#</a> amend</h4><p>修正上次提交（提交暂存区中的文件，并修改 commit 信息），不会影响其它信息。实际上是用一个新的提交替换旧的提交，旧的提交就像从未存在过一样。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> commit <span class="token parameter variable">--amend</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="reset" tabindex="-1"><a class="header-anchor" href="#reset" aria-hidden="true">#</a> reset</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 取消暂存 b.txt</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="远程仓库" tabindex="-1"><a class="header-anchor" href="#远程仓库" aria-hidden="true">#</a> 远程仓库</h3><h4 id="remote" tabindex="-1"><a class="header-anchor" href="#remote" aria-hidden="true">#</a> remote</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 展示所有远程分支简称和URL。clone 时的源地址默认名称为 origin</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="fetch" tabindex="-1"><a class="header-anchor" href="#fetch" aria-hidden="true">#</a> fetch</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 拉取最新的远程仓库数据到本地，但不会自动合并或修改</span>
<span class="token function">git</span> fetch <span class="token operator">&lt;</span>remote<span class="token operator">&gt;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="push" tabindex="-1"><a class="header-anchor" href="#push" aria-hidden="true">#</a> push</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 将本地的 master 推送到 origin，有冲突时需要先拉取合并</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="标签" tabindex="-1"><a class="header-anchor" href="#标签" aria-hidden="true">#</a> 标签</h3><p>Git 里可以给特定的提交打上一个标签，可以通过 checkout 检出。标签分两种类型：</p><ul><li><strong>轻量标签 lightweight</strong>：没有多余信息</li><li><strong>附注标签 annotated</strong>：包含标签信息等冗余信息，可以用 GPG 签名并验证</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 检索标签</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="gitignore-规则" tabindex="-1"><a class="header-anchor" href="#gitignore-规则" aria-hidden="true">#</a> .gitignore 规则</h3><ul><li>所有空行或者以<code>#</code>开头的行都会被 Git 忽略</li><li>可以使用标准的 glob 模式（简化正则）匹配，它会递归地应用在整个工作区中 <ul><li><code>*</code>匹配零个或多个任意字符</li><li><code>[abc]</code>匹配方括号中的单个字符</li><li><code>?</code>匹配一个任意字符</li><li><code>[0-9]</code>匹配范围区间</li><li><code>a/**/z</code>匹配任意中间目录，如<code>a/z, a/b/z, a/b/c/z</code></li></ul></li><li>匹配模式可以以<code>/</code>开头防止递归</li><li>匹配模式可以以<code>/</code>结尾指定目录</li><li>要忽略指定模式以外的文件或目录，可以在模式前加上叹号<code>!</code>取反</li><li>根目录下的<code>.gitignore</code>递归作用到整个仓库，子目录下的<code>.gitignore</code>仅作用于所在目录</li></ul>`,19),P={href:"https://github.com/github/gitignore",target:"_blank",rel:"noopener noreferrer"},S=a('<h2 id="分支" tabindex="-1"><a class="header-anchor" href="#分支" aria-hidden="true">#</a> 分支</h2><p>几乎所有的版本控制系统都以某种形式支持分支，使用分支意味着可以把正在进行的工作从开发主线上分离开来，以免影响开发主线。下面看看 Git 实现分支的逻辑，需要牢记 Git 保存的不是文件的变化或者差异，而是不同时刻的快照。</p><h3 id="分支结构" tabindex="-1"><a class="header-anchor" href="#分支结构" aria-hidden="true">#</a> 分支结构</h3><p>假设我们现在的 Git 项目里有三个文件已经暂存，当初次执行提交时，Git 会先计算每一个子目录的校验和， 然后在 Git 仓库中将这些校验和（黄色）保存为一个树对象（蓝色），记录着目录结构和 blob 文件索引，这个树就可以看作是仓库的一个快照。随后 Git 会创建一个提交对象（白色），除了包含提交本身相关的信息，比如作者、日期等等之外，还包含一个指向这个树对象的指针。</p><p><img src="'+m+'" alt="" loading="lazy"></p><p>当我们对仓库里的文件做一些修改，再次提交时，就会再次创建若干 blob 和一个树对象，以及一个提交对象，并且这个提交对象里包含一个指向上次提交对象（父对象）的指针，这样若干次的提交就形成了一个链表结构。</p><p><img src="'+u+'" alt="" loading="lazy"></p><p>至于分支，实质上就是指向一个提交记录的可变指针，比如默认的 master 就指向了主干上最新的提交记录，而创建一个新分支/标签实际上就是创建一个指向 HEAD 所在提交记录的指针，实现上也就是往一个文件里写入 40 个字节的 SHA-1 值和 1 个换行符，因此效率非常高。HEAD 是一个特殊指针，指向当前所在的本地分支，随着 checkout 检出而移动。</p><p><img src="'+v+`" alt="" loading="lazy"></p><h3 id="分支管理" tabindex="-1"><a class="header-anchor" href="#分支管理" aria-hidden="true">#</a> 分支管理</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建分支</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11),L={href:"https://www.cnblogs.com/xueweihan/p/13524162.html",target:"_blank",rel:"noopener noreferrer"},F=a('<h3 id="分支合并" tabindex="-1"><a class="header-anchor" href="#分支合并" aria-hidden="true">#</a> 分支合并</h3><h4 id="fast-forward" tabindex="-1"><a class="header-anchor" href="#fast-forward" aria-hidden="true">#</a> Fast-forward</h4><p>如果一个分支的任务完成，需要将它合并入主分支。对于下面这个分支结构，当前处在 master 分支。</p><p><img src="'+b+'" alt="" loading="lazy"></p><p>如果执行<code>git merge hotfix</code>，由于 hotfix 指向的 C4 提交是 merge 指向的 C2 提交的直接后继，因此 Git 将执行<code>fast-forward</code>以<strong>快进</strong>方式合并，即让 master 指针直接后移。之后可以执行 <code>git branch -d hotfix</code>删除已合并的分支。</p><p><img src="'+g+'" alt="" loading="lazy"></p><h4 id="recursive" tabindex="-1"><a class="header-anchor" href="#recursive" aria-hidden="true">#</a> Recursive</h4><p>但实际中更多的是下面这种无法快进的分支合并结构，即两个分支有共同祖先，但不是直接后继。</p><p><img src="'+h+'" alt="" loading="lazy"></p><p>此时如果执行<code>git merge iss53</code>，那么 Git 将针对<strong>两个分支的末端提交和它们的公共祖先</strong>执行<strong>三方合并</strong>（C4、C5、C2），创建一个新的快照和提交 C6 作为最新版本，并且 C6 会有两个父提交 C4 和 C5。</p><p><img src="'+k+`" alt="" loading="lazy"></p><p>如果在三方合并的过程中，遇到合并冲突，即不同分支同时修改了同一块数据，那么 Git 会将冲突的内容用下面的格式展示在文件中，然后暂停下来，由用户自己处理完冲突后手动暂存和提交。</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>&lt;&lt;&lt;&lt;&lt;&lt;&lt; HEAD:index.html								<span class="token comment">&lt;!-- HEAD 指示版本 --&gt;</span>							
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="变基" tabindex="-1"><a class="header-anchor" href="#变基" aria-hidden="true">#</a> 变基</h3><p>不同于 merge 的三方合并或快进，rebase 变基操作可以将修改的补丁（C4）迁移到另一个分支（master）上。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 将某个分支变基到 master上，默认是当前分支</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>假设我们有如下的分支结构，当前在 experiment 分支上，想要变基到 master 上，整个流程是这样的：</p><ol><li>Git 首先会找到两个分支的共同祖先 C2</li><li>然后对比当前分支（experiment）相对于该祖先的历次提交，提取相应的修改暂存</li><li>接着将当前分支指向目标（master）基底 C3，依次应用暂存的修改 C4&#39;</li><li>最后 experiment 会指向最后一次修改的补丁 C4&#39;</li></ol><p>至此变基完成，然后手动检出到 master 执行快进合并即可。</p><p><img src="`+f+`" alt="" loading="lazy"></p><p>变基与合并的结果没有任何区别，但变基使得提交历史更加整洁，原本并行的开发过程就像是串行的一样。但是变基存在一定风险，切记不要对已推送至别处的提交执行变基操作。</p><p>从合作的开发者的角度看，提交记录就是开发的历史，理论上不应该&quot;篡改&quot;，而从读者或者是新加入的开发者角度看可能只需要关注最终的结果，过程方便易读最好，所以变基与合并各有不同。</p><h3 id="远程分支" tabindex="-1"><a class="header-anchor" href="#远程分支" aria-hidden="true">#</a> 远程分支</h3><p>远程引用是对远程仓库的引用（指针），包括分支、标签等以 <code>&lt;remote&gt;/&lt;branch/tag&gt;</code> 的形式命名，origin 是默认的远程仓库引用。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 克隆远程仓库并指定一个引用名，默认是 origin</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+x+`" alt="" loading="lazy"></p><p>从一个远程跟踪分支检出一个本地分支会自动创建<strong>跟踪分支</strong>，跟踪的远程分支叫做<strong>上游分支</strong>。也就是说本地的某个分支关联到远程仓库的某个分支，在拉取和推送时能自动关联到对应的上游分支。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 检出远程 origin 仓库的 serverfix 分支，命名为 local_branch，并自动跟踪</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="高级工具" tabindex="-1"><a class="header-anchor" href="#高级工具" aria-hidden="true">#</a> 高级工具</h2><p>众所周知，高级工具，就是很麻烦，通常也用不太到的奇技淫巧...</p><h3 id="提交引用" tabindex="-1"><a class="header-anchor" href="#提交引用" aria-hidden="true">#</a> 提交引用</h3><h4 id="单提交" tabindex="-1"><a class="header-anchor" href="#单提交" aria-hidden="true">#</a> 单提交</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 通过 SHA-1 引用，支持简写（只要没有冲突）</span>
...
<span class="token function">git</span> show HEAD~2
<span class="token function">git</span> show HEAD~~
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="多提交" tabindex="-1"><a class="header-anchor" href="#多提交" aria-hidden="true">#</a> 多提交</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 双点区间，输出在 refA 中但不在 refB 中的提交</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="贮藏清理" tabindex="-1"><a class="header-anchor" href="#贮藏清理" aria-hidden="true">#</a> 贮藏清理</h3><p><strong>stash</strong> 还是一个很有用，也很常用的功能，可以跟踪文件的修改与暂存的改动，将未完成的修改保存到一个<strong>栈</strong>上，留待以后重新应用这些改动。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 贮藏当前的修改，-u/--include-untracked 包括未跟踪的</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="重写历史" tabindex="-1"><a class="header-anchor" href="#重写历史" aria-hidden="true">#</a> 重写历史</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 将当前分支指针移动到三个提交之前的父提交，开始变基</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面谈谈 <strong>reset</strong> 和 <strong>checkout</strong> 两个命令的原理。首先要知道 Git 管理了三颗不同的树：</p><ol><li><strong>HEAD</strong> 上一次提交的快照，下一次提交的父结点。也就是当前分支引用的指针，总是指向该分支上的最后一次提交。</li><li><strong>Index</strong> 预期的下一次提交的快照。，理解成暂存区。</li><li><strong>Working Directory</strong> 沙盒，也就是当前的工作目录。</li></ol><p>假设我们当前仓库里有一个文件的v1版本，状态如下： <img src="`+_+'" alt="" loading="lazy"></p><p>当我们修改了文件为 v2 版本后，状态如下： <img src="'+A+'" alt="" loading="lazy"></p><p>当执行完 <code>git add</code> 命令后： <img src="'+E+'" alt="" loading="lazy"></p><p>当执行完 <code>git commit</code> 命令后： <img src="'+G+'" alt="" loading="lazy"></p><p>现在如果执行 git status 将没有输出，因此三棵树是完全一样的。这时候如果我们执行 <code>git reset --soft HEAD~</code>来回到上一个提交，实际上是移动了当前分支（是一个指针）已到了上一次提交，HEAD 也跟着移动过去了，reset 执行就到此为止了，没有修改暂存区/工作区数据。</p><p><img src="'+H+'" alt="" loading="lazy"></p><p>而如果执行的是<code>git reset --mixed HEAD~</code>，那么会进一步的，用 HEAD 指向的快照来更新暂存区内的数据，这也是 reset 无参的缺省行为。</p><p><img src="'+D+'" alt="" loading="lazy"></p><p>而如果执行的是<code>git reset --hard HEAD~</code>，那么会再进一步的，用 HEAD 指向的快照来更新暂存区，以及工作区内的数据，并且是强制的没有任何提示的，所以是一个危险的操作！</p><p><img src="'+w+'" alt="" loading="lazy"></p><p>最后如果执行的是<code>git reset file.txt</code>带有文件路径的形式，那么本质上只是将某个文件从快照中复制到暂存区。</p><p><img src="'+y+`" alt="" loading="lazy"></p><p>搞懂了 reset 之后，再看 checkout 就容易多了，checkout 实际上只是移动了 HEAD 指针指向另一个分支指向的提交，并没有改变任何分支的指针。</p><h3 id="hooks" tabindex="-1"><a class="header-anchor" href="#hooks" aria-hidden="true">#</a> Hooks</h3><p>Git 支持在特定的重要动作发生时触发自定义脚本，即钩子，存放在<code>.git/hooks</code>目录下。分类如下：</p><ul><li>客户端钩子：clone 时不随同复制 <ul><li>提交工作流： <ul><li><code>pre-commit</code>键入提交信息前运行，如果以非0值退出将放弃提交。用于检查即将提交的快照</li><li><code>prepare-commit-msg</code>启动提交信息编辑器之前，默认信息被创建之后运行。可以编辑默认的提交信息</li><li><code>commit-msg</code>提交信息编辑后运行，非0值退出将放弃提交。可以校验项目状态和提交信息</li><li><code>post-commit</code>整个提交过程完成后运行，可用于通知事件</li></ul></li><li>电子邮件：由<code>git am</code>命令调用 <ul><li><code>applypatch-msg</code>、<code>pre-applypatch</code>、<code>post-applypatch</code></li></ul></li><li>其它： <ul><li><code>pre-rebase</code>运行于变基之前，非0值退出将中止变基</li><li><code>post-rewrite</code>被那些会替换提交记录的命令调用，如 <code>git rebase</code></li><li><code>post-checkout</code> checkout 执行成功后运行，可以调整工作目录</li><li><code>post-merge</code> merge 执行成功后运行，可以恢复 Git 无法跟踪的工作区数据</li><li><code>pre-push</code>在<code>git push</code>运行期间， 更新了远程引用但尚未传送对象时被调用</li><li><code>pre-auto-gc</code>垃圾回收开始之前被调用</li></ul></li></ul></li><li>服务端钩子： <ul><li><code>pre-receive</code>处理来自客户端的推送操作时运行，非0值退出将拒绝推送更新</li><li><code>update</code>也是处理客户端推送，但会为每个分支各执行一次，哪个运行结果非0就拒绝更新哪个分支</li><li><code>post-receive</code>整个过程完结以后运行，可以用来更新其他系统服务或者通知用户</li></ul></li></ul><h3 id="数据恢复" tabindex="-1"><a class="header-anchor" href="#数据恢复" aria-hidden="true">#</a> 数据恢复</h3><p>如果因为意外丢失了一些有用的提交，Git 有一些方式可以恢复丢失的提交数据：</p><ul><li>Reflog 日志：提交或改变分支时，Git 会在该日志中记录 HEAD 修改的值</li><li>fsck：该工具可以检查数据库的完整性，显示出所有悬空的对象（没有被其它对象指向）</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看 HEAD 引用的变更记录</span>
<span class="token function">git</span> reflog
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="其它" tabindex="-1"><a class="header-anchor" href="#其它" aria-hidden="true">#</a> 其它</h3><ol><li><strong>Rerere</strong> = <strong>Reuse Recorded Resolution</strong>，可以实现重用冲突解决的方案，通过<code>git config rerere.enabled true</code>开启这个功能后，会自动记录合并冲突的解决方案，后续遇到相同的冲突（很罕见的场景吧...）会自动应用解决方案。</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 重用记录状态</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>Git 提供了一些辅助调试的命令：</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 显式文件的 70-80 行，每行最后一次修改对应的提交记录; -C 自动追踪复制源</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>Git 支持子模块功能，允许将一个 Git 仓库作为另一个仓库的子目录，同时保持提交的独立。</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> submodule <span class="token function">add</span> https://github.com/<span class="token operator">&lt;</span>username<span class="token operator">&gt;</span>/<span class="token operator">&lt;</span>repo<span class="token operator">&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>Bundle 打包功能可以将更新打包成一个二进制文件，用于传输。</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建一个 repo.bundle 包含所有用于重建 master 分支所需的数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="5"><li>Git 拥有一个凭证系统处理身份认证，有以下几种选项：</li></ol><ul><li>默认所有都不缓存。 每一次连接都会询问你的用户名和密码</li><li><strong>cache</strong> 模式会将凭证存放在内存中一段时间，例如 15 分钟后从内存中清除</li><li>**store **凭证用明文的形式存放在磁盘中，并且永不过期</li><li>Mac 的 osxkeychain 模式会将凭证存入提供的钥匙串中</li><li>Windows 下有类似的 Git Credential Manager for Windows 辅助工具</li></ul><h2 id="内部原理" tabindex="-1"><a class="header-anchor" href="#内部原理" aria-hidden="true">#</a> 内部原理</h2><p>从根本上来讲，Git 是一个内容寻址文件系统，核心部分是一个简单的键值对数据库，在此之上提供了一个版本控制系统的用户界面。</p><h3 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构" aria-hidden="true">#</a> 目录结构</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">ls</span> <span class="token parameter variable">-F1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="git-对象" tabindex="-1"><a class="header-anchor" href="#git-对象" aria-hidden="true">#</a> Git 对象</h3><p>每次运行 git add 、git commit 命令时，Git 所做的实质上就是：</p><ol><li>将被改写的文件保存为<strong>数据对象 blob</strong></li><li>更新暂存区，记录<strong>树对象 tree</strong></li><li>最后创建一个指明顶层树对象和父提交的<strong>提交对象 commit</strong></li></ol><p>数据对象、树对象、提交对象 三种主要的 Git 对象均以单独文件的形式保存在<code>.git/objects</code>目录下。</p><p><img src="`+C+`" alt="" loading="lazy"></p><p>操纵 Git 对象的命令有以下的一些底层命令，也是 Git 上层命令实际调用的方法。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 返回对象的 hash 键，-w 写入数据库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="git-引用" tabindex="-1"><a class="header-anchor" href="#git-引用" aria-hidden="true">#</a> Git 引用</h3><p>GIt 中通过引用 refs (references) 来替代原始的 SHA-1 值，更加简便。引用都保存在<code>.git/refs</code>目录下，包括<code>heads</code>保存分支引用、<code>tags</code>标签引用、<code>refs/remotes</code>远程引用等。HEAD 文件是一个特殊的引用，通常是一个符号引用（指向其它引用），指向目前所在的分支，除非是处在<code>detached HEAD</code>分离头指针状态。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 更新某个引用，所以说分支的本质就是指向某个提交的指针</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,90);function I(N,T){const e=l("ExternalLinkIcon");return c(),o("div",null,[z,s("p",null,[n("log 命令打印提交历史记录，支持很多种格式化工具，调整输出样式，并且支持多种过滤器限定事件、作者、关键字等等，详细参数参考 "),s("a",B,[n("Git - 查看提交历史"),i(e)]),n("。")]),R,s("p",null,[s("a",P,[n("https://github.com/github/gitignore"),i(e)]),n(" 给出了针对各种项目和语言的忽略跟踪文件，或者直接问 ChatGPT 吧更方便。")]),S,s("p",null,[n("另外，团队可以根据不同的需求和常见，选择合适的分支开发流，如集中式、集成管理者、主管与副主管等等，可以参考："),s("a",L,[n("5 个 Git 工作流，改善你的开发流程 - 削微寒 - 博客园"),i(e)]),n("。")]),F])}const J=t(q,[["render",I],["__file","git-pro.html.vue"]]);export{J as default};
